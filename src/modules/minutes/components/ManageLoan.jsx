...
export const ManageLoan = ({ reloadTable }) => {
  const {
    state,
    formValidator,
    resetFormState,
    handleFormSubmit,
    handleFormChange,
  } = useManageTransactionEntry({ transactionType: "loan", reloadTable });
  ...
  return (
    <GeneralDialog
      dialogValue="?new-loan"
      disableCloseOnBackgroundClick={false}
    >
      <DialogHeader title="New Loan" resetCache={resetFormState} />
