...
export const ManageRefund = ({ reloadTable }) => {
  const {
    state,
    formValidator,
    resetFormState,
    handleFormSubmit,
    handleFormChange,
  } = useManageTransactionEntry({ transactionType: "refund", reloadTable });
  ...
  return (
    <GeneralDialog
      dialogValue="?new-refund"
      disableCloseOnBackgroundClick={false}
    >
      <DialogHeader title="New Refund" resetCache={resetFormState} />
