...
export const ManageMemberFee = ({ reloadTable }) => {
  const {
    state,
    formValidator,
    resetFormState,
    handleFormSubmit,
    handleFormChange,
  } = useManageTransactionEntry({ transactionType: "member fee", reloadTable });
  ...
  return (
    <GeneralDialog dialogValue="?new-fee" disableCloseOnBackgroundClick={false}>
      <DialogHeader title="New Membership Fee" resetCache={resetFormState} />
