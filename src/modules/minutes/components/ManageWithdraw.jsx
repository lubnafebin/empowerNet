...
export const ManageWithdraw = ({ reloadTable }) => {
  const {
    state,
    formValidator,
    resetFormState,
    handleFormSubmit,
    handleFormChange,
  } = useManageTransactionEntry({ transactionType: "withdraw", reloadTable });
  ...
  return (
    <GeneralDialog
      dialogValue="?new-withdraw"
      disableCloseOnBackgroundClick={false}
    >
      <DialogHeader title="New Withdraw" resetCache={resetFormState} />
